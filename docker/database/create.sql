...
--
-- Host: 127.0.0.1    Database: ng-framework
-- ------------------------------------------------------
...
-- Create database
--
DROP DATABASE IF EXISTS `phpapi`;
CREATE DATABASE phpapi;

-- create/grant a user
grant all on phpapi.* to 'phpapi'@'%' identified by 'pHp@p1!';

-- use phpapi for the rest of this;
use phpapi;
...
-- Dump completed on 2017-08-25 15:49:07
